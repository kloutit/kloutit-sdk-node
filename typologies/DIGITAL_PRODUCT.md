### Sample Case model for Digital Product sector

This is a sample UpdateCaseParams for Digital Product sector with all the parameters it admits.
...
const kloutitCase: UpdateCaseParams = {
  sector: KloutitOrganizationType.DIGITAL_PRODUCT,
